...
module "apinine_flood_rcp45" {
  ...
  description   = "This function returns the flood risk analysis on the provided location for rcp 4.5 (address or lat and lon)."
  ...
  environment_variables = {
    ...
    "POWERTOOLS_SERVICE_NAME" : "APININE_FLOOD_RCP45",
